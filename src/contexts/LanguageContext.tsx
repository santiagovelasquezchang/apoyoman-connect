...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Hero Section
    "hero.eyebrow": "OPERATIONS FOR ENERGY TEAMS",
    ...
    "hero.cap1": "Headhunting & technical recruiting across all levels",
    "hero.cap2": "Staff outsourcing with full labor compliance",
    "hero.cap3": "Payroll administration & statutory benefits",
    "hero.cap4": "Logistics, housing & site services coordination",
    "hero.cap5": "Single-contract model — one vendor, zero fragmentation",
    "hero.stat1.value": "1989",
    "hero.stat1.label": "Founded",
    "hero.stat2.value": "20+",
    "hero.stat2.label": "Years Experience",
    "hero.stat3.value": "1,370+",
    "hero.stat3.label": "Workers Managed",
    "hero.stat4.value": "5",
    "hero.stat4.label": "Major Projects",
  ...
  es: {
    ...
    // Hero Section
    "hero.eyebrow": "OPERACIONES PARA EQUIPOS DE ENERGÍA",
    ...
    "hero.cap1": "Headhunting y reclutamiento técnico en todos los niveles",
    "hero.cap2": "Outsourcing de personal con cumplimiento laboral total",
    "hero.cap3": "Administración de nómina y prestaciones sociales",
    "hero.cap4": "Logística, vivienda y coordinación de site services",
    "hero.cap5": "Modelo de contrato único — un proveedor, cero fragmentación",
    "hero.stat1.value": "1989",
    "hero.stat1.label": "Fundada",
    "hero.stat2.value": "20+",
    "hero.stat2.label": "Años de Experiencia",
    "hero.stat3.value": "1,370+",
    "hero.stat3.label": "Trabajadores Gestionados",
    "hero.stat4.value": "5",
    "hero.stat4.label": "Proyectos Principales",
